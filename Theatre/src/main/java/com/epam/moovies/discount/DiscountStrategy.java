...
public enum DiscountStrategy {
    BIRTHDAY_STRATEGY(BirthdayStrategyDiscountCalulator.class),
    EVERY_10_TICKET(Every10TicketDiscountCalculator.class),
    LUCKY_WINNER(LuckyWinnerDiscountCalculator.class);
